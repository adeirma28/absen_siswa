                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    <label class="custom-control custom-checkbox custom-control-inline">
                                                        <input class="optioncheck custom-control-input" name="optioncheck[]" value="<?php echo $data['id_siswa'] ?>" type="checkbox" />
                                                            <span class="custom-control-label"></span>
                                                        </label>
                                                    </th>
                                                    ...
                                                    <td class="td-nama">
                                                        <span  data-value="<?php echo $data['nama']; ?>" 
                                                            ...
                                                            data-url="<?php print_link("data_siswa/editfield/" . urlencode($data['id_siswa'])); ?>" 
                                                            data-name="nama" 
