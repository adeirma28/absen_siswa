 ...
 * @category  Controller
 */
class Data_siswaController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->orderby)){
			...
			$db->orderBy("data_siswa.id_siswa", ORDER_TYPE);
		}
		if($fieldname){
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("data_siswa.id_siswa", $rec_id);; //select record based on primary key
		}
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("nama","nik","jenis_kelamin","nama_ayah","nama_ibu","alamat","photo");
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'nama' => 'required',
				'nik' => 'required|max_len,13|min_len,13',
		...
		$page_title = $this->view->page_title = "Add New Data Siswa";
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_siswa","nama","nik","jenis_kelamin","nama_ayah","nama_ibu","alamat","photo");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'nama' => 'required',
			...
			$modeldata = $this->modeldata = $this->validate_form($postdata);
			if($this->validated()){
				$db->where("data_siswa.id_siswa", $rec_id);;
	...
	function delete($rec_id = null){
		...
		$db->where("data_siswa.id_siswa", $arr_rec_id, "in");
